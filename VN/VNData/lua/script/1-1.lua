...
s("유미", "잘 부탁드려요, 관리자님.")
s("유미", "저는 이지적이고 유능한 커리어 우먼, 유미라고 해요.")
s("유미", "이곳에서 관리자님을 안내해드리고, 기지국의 업무를 친절히 알려드릴 예정이죠.")
s("유미", "편하게 반말로 불러주세요.")
...
-- SCG 1, "Yumi_Daze"
s("유미", "…죄송해요. 분위기 좀 띄워보려고 농담 좀 한 건데.")

-- SCG 1, "Yumi_Smile"
s("유미", "호주에 오신 건 처음이시죠? 그렇게 딱딱한 표정 짓지 마시구. 네?")
...
-- -- SCG_Light 1
s("유미", "이제 막 도착하셔서 정신없으시죠? 도시로 가는 동안에는 잠시 주무셔도 돼요.")
...
s("유미", "아무리 그래도 마음 여린 숙녀한테 그런 말씀을 하시다니….")
